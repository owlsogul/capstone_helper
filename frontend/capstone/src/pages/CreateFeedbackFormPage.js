...
import CreateFeedbackForm from '../components/CreateFeedbackForm.component'
import '../App.css'
...
export default class CreateFeedbackFormPage extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div>
                <CreateFeedbackForm match={this.props.match}></CreateFeedbackForm>
            </div>
        );
    }
}